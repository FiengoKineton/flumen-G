...
if __name__ == "__main__":
    sections = {
        'VDP': {
            'old': 'src/flumen/finals/old_vdp.csv',
            'lpv': 'src/flumen/finals/vdp-lpv.csv',
            'static': 'src/flumen/finals/vdp-static.csv',
        },
        'FHN': {
            'old': 'src/flumen/finals/old_fhn.csv',
            'new': 'src/flumen/finals/fhn.csv',
        },
        'NAD': {
            'old_stable': 'src/flumen/finals/old_nad-stable.csv',
            'new_stable': 'src/flumen/finals/nad-stable.csv',
            'old_big': 'src/flumen/finals/old_nad-big.csv',
            'new_big': 'src/flumen/finals/nad-big.csv',
        }
    }
    ...
    """
    VDP best runs: 
    - old | vdp_fin-old: (wandb) aguiar-kth-royal-institute-of-technology/g7-fiengo-msc-thesis/flumen-vdp_test_data-ge1as8ds:v1
    ...
    (vdp_lpv.pdf) python experiments/interactive_test_compare.py --wandb aguiar-kth-royal-institute-of-technology/g7-fiengo-msc-thesis/flumen-vdp_test_data-lbz1tnpu:v3 --wandb_2 aguiar-kth-royal-institute-of-technology/g7-fiengo-msc-thesis/flumen-vdp_test_data-ge1as8ds:v1
    (vdp_static.pdf) python experiments/interactive_test_compare.py --wandb aguiar-kth-royal-institute-of-technology/g7-fiengo-msc-thesis/flumen-vdp_test_data-lwqp2l3z:v3 --wandb_2 aguiar-kth-royal-institute-of-technology/g7-fiengo-msc-thesis/flumen-vdp_test_data-ge1as8ds:v1
